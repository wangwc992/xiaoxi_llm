...
def getDepartmentProjectList(intention_study_abroad: IntentionStudyAbroad):
    ...
    return xxlxdb.execute_all2dict(sql ,params=())


if __name__ == '__main__':
    intention_study_abroad = IntentionStudyAbroad(
        country='澳大利亚',
        school_en_name='UNSW Sydney',
        degree='博士',
        duration='3.5年',
        semester='5',
        city='悉尼'
    ...
    x = getDepartmentProjectList(intention_study_abroad)
