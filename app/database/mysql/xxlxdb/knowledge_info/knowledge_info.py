...
def search_knowledge_info_data(id=0, limit=10):
    sql = f"SELECT id, type, country, school, class, name, founder,filename, replyerTime, content, fileurl FROM t_knowledge_info where startup_status = 1 and id > {id} and id < 26000 "
